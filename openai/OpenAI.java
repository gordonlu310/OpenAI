...
@DesignerComponent(version = 1, description = "An extension that allows you to use AI and connect with OpenAI.", iconName = "aiwebres/icon.png", category = ComponentCategory.EXTENSION,
nonVisible = true)
...
public class OpenAI extends AndroidNonvisibleComponent {
    ...
    public void Chat(final String prompt, @Options(Model.class) final String model, final String apiKey, final int maxTokens, final boolean informative) {
